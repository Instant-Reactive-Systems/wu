...
fn ErrorPage(
    ...
    if errors.is_empty() { unreachable!("should always have at least one error") }
    ...
    view! {
        <div class="grow flex center">
            <main class="w-3/4 desktop:w-1/2 wide:w-[1024px] vertical gap-2 hcenter">
...
pub fn AppRouter() -> impl IntoView {
    let fallback = move || {
        ...
        outside_errors.insert_with_default_key(AppError { code: http::StatusCode::NOT_FOUND, what: "Page not found".to_string() });
